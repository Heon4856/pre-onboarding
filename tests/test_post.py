...
class TestCase(unittest.TestCase):
    ...
    def db_setUp(self):
        ...
        post = Post(subject="subject", content="content", create_date=datetime.now(), user_id=1)
    ...
    def test_get_post_list(self):
        """get_post_list시 pagenation이 되는지 테스트"""
        url = '/'
